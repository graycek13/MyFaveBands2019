...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //Menus
        ListOfPhotos = [
            UIImage(named: "LilyAllen.jpg")!,
            UIImage(named: "OneDominion.jpg")!,
            UIImage(named: "LaurenAlaina.jpg")!,
            UIImage(named: "beyonce.jpg")!,
            UIImage (named: "TheBeatles.jpg")!,
            UIImage (named: "RileyGreen.jpg")!,
            UIImage (named: "AnnaClendening.jpg")!,
            UIImage (named: "Maroon5.jpg")!
        ]
        
        ListOfFavs = ["Lily Allen","One Dominion","Lauren Alaina", "Beyonce", "The Beatles", "Riley Green", "Anna Clendening", "Maroon 5"]
        FavDetails = ["https://www.youtube.com/watch?v=0WxDrVUrSvI","https://www.youtube.com/watch?v=0lxA1FXOiv0","https://www.youtube.com/watch?v=qcCH6JpcK5w", "https://www.youtube.com/watch?v=bnVUHWCynig", "https://www.youtube.com/watch?v=45cYwDMibGo", "https://www.youtube.com/watch?v=LyxjNSHNYwk", "https://www.youtube.com/watch?v=aGl5sZZedrc", "https://www.youtube.com/watch?v=SlPhMPnQ58k"]
